...
await writeFile(path.join(dist,'version.json'),JSON.stringify({name:'Nerdspace Labs Dashboard',version:'1.21.1'},null,2));
console.log('Built Nerdspace Labs Dashboard Alpha 1.21.1 into dist/');
